...
//added by james for jquery cycle plugin
//drupal_add_js("sites/all/themes/coleSister/jquery.cycle.all.pack.js");
//drupal_add_js("sites/all/themes/coleSister/slideshow.js");
//drupal_add_js("sites/all/themes/coleSister/jquery.galleria.pack.js");
 ...
 * paste it here, changing the prefix from theme_ to coleSister_. For example:
 *
 *   original: theme_breadcrumb()
 *   theme override: coleSister_breadcrumb()
 *
 * where coleSister is the name of your sub-theme. For example, the zen_classic
...
if (theme_get_setting('coleSister_fixed')) {
 ...
 */
function coleSister_theme(&$existing, $type, $theme, $path) {
...
function coleSister_preprocess(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */

/*
added by james for php menu items
came from:
http://drupal.org/node/227607
*/
 ...
 */
/* -- Delete this line if you want to use this function
function coleSister_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function coleSister_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function coleSister_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function coleSister_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function coleSister_username($object) {
